...
export const editorActions = (dispatch: Dispatch<Action>) => (
  {
    ...
    selectElement: (payload: { id: string }) => dispatch({ type: actionTypes.SELECT_ELEMENT, payload }),
    deselectElement: (payload: { id: string }) => dispatch({ type: actionTypes.DESELECT_ELEMENT, payload }),
